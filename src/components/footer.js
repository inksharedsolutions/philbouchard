            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Phil Bouchard loves to hear from readers. You can reach him via email.
                        ...
                        <nav className="social-media-nav">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.facebook.com/Phil-Bouchard-101512971979449"
                                        target="_blank"
                                        rel="noreferrer">
                                        <FontAwesomeIcon
                                ...
                                <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/56550489-finite-theory"
                                        rel="noreferrer">
